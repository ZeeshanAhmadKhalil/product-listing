...
(function ($) {
    ...
    ------------------------------ */
      ...
      $('.blog-gallery').slick({
        ...
        infinite: true,
        arrows: true,
        prevArrow:'<span className="prev"><i className="ion-ios-arrow-left"></i></span>',
        nextArrow: '<span className="next"><i className="ion-ios-arrow-right"></i></span>',
        speed: 800,
        slidesToShow: 1,
        slidesToScroll: 1,
    });
    ...
    ---------------------------- */
    $.scrollUp({
        scrollText: '<i className="fas fa-arrow-up"></i>',
        easingType: 'linear',
        scrollSpeed: 900,
        animation: 'fade'
    });
  ...
  /*-------------------------
    ...
    $(".vertical-menu li.hidden").hide();
       $("#more-btn").on('click', function (e) {
        ...
        var htmlAfter = '<i className="ion-ios-minus-empty" aria-hidden="true"></i> Less Categories';
        var htmlBefore = '<i className="ion-ios-plus-empty" aria-hidden="true"></i> More Categories';
    ...
    $('[data-countdown]').each(function() {
        ...
        $this.countdown(finalDate, function(event) {
            $this.html(event.strftime('<span className="cdown day">%-D <p>Days</p></span> <span className="cdown hour">%-H <p>Hours</p></span> <span className="cdown minutes">%M <p>Mins</p></span> <span className="cdown second">%S <p>Sec</p></span>'));
        });
    });
